        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-1">
                    <h3 class="content-header-title">Edit Event</h3>
                </div>
                <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('event.record') }}">Event</a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group @error('title') has-error @enderror">
                                                        ...
                                                        <input type="text" name="title" id="title" class="form-control  @error('title') is-invalid @enderror" value="{{ old('title')??$data->title }}" placeholder="Ex. The Cricket" required>
                                                        @error('title')
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group @error('event_date_time') has-error @enderror">
                                                        ...
                                                        <div class="input-group date" id="datetimepicker1">
                                                            <input type="text" name="event_date_time" id="event_date_time" class="form-control @error('event_date_time') is-invalid @enderror" value="{{ old('event_date_time')??$data->event_date_time }}" required/>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group @error('status') has-error @enderror">
                                                        ...
                                                        <select name="status" id="status" class="form-control  @error('status') is-invalid @enderror" required>
                                                            ...
                                                            <option value="2" @if($data->status == 2) {{ 'selected' }} @endif>In-Active</option>
                                                        </select>
                                                        @error('status')
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group @error('details') has-error @enderror">
                                                        ...
                                                        <textarea name="details" id="details" cols="30" rows="10" class="form-control  @error('details') is-invalid @enderror" required>{{ old('details')??$data->details }}</textarea>
                                                        @error('details')
